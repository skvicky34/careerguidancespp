...
<title>User Career Choice</title>
	...
	<div id="wrapper">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<table width="80%" style="background-color: #fff; margin-left: 75px"
					border=1>
					<tr>
						<th>Type</th>
						<th>Name</th>
					...
					<tr>
						<td>${userCareerData.type}</td>
						<td>${userCareerData.name}</td>
						<td>${userCareerData.description}</td>
					</tr>

				</table>
				<br> <br>
				<div id="msg"
					style="text-align: center; font-weight: 800; font-size: 20px">${careerSaveMsg}</div>
