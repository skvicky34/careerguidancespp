...
<body id="page-top">
	...
	<a href="javascript:void(0);" class="btnPrevious"><img src="admin/img/next.png" width="40" /></a><ul>
			<li><img src="admin/img/AeronauticalEngineer.jpg" /><div>Aeronautical Engineer</div></li>
			<li><img src="admin/img/AgriculturalBiotechnologist.jpg" /><div>Agricultural BioTechnologist</div></li>
			<li><img src="admin/img/Architect.jpg" /><div>Architect</div></li>
			<li><img src="admin/img/BusinessManager.jpg" /><div>Business Manager</div></li>
			<li><img src="admin/img/ChartedAccountant.jpg" /><div>Charted Accountant</div></li>
			<li><img src="admin/img/ComputerEngineer.jpg" /><div>ComputerEngineer</div></li>
			<li><img src="admin/img/Entrepreneur.jpg" /><div>Entrepreneur</div></li>
			<li><img src="admin/img/FashionDesigner.jpg" /><div>Fashion Designer</div></li>
			<li><img src="admin/img/IndustrialDesigner.jpg" /><div>Industrial Designer</div></li>
			<li><img src="admin/img/Psychologist.jpg" /><div>Psychology Courses</div></li>
