...
<body>
	...
	<section class="section main-banner" id="top" data-section="section1">
		...
		<div class="video-overlay header-text">
			<div class="caption">
				<h6>Global Career Guidance System</h6>
				<h2>
					<em>Career</em> Guidance
				</h2>
					...
					<div class="features-post">
						<div class="features-content">
							<div class="content-show">
								<h4>
									<i class="fa fa-pencil"></i>All Courses
								</h4>
							</div>
							<div class="content-hide">
								<p>Curabitur id eros vehicula, tincidunt libero eu, lobortis
									mi. In mollis eros a posuere imperdiet. Donec maximus elementum
									ex. Cras convallis ex rhoncus, laoreet libero eu, vehicula
									libero.</p>
								<p class="hidden-sm">Curabitur id eros vehicula, tincidunt
									libero eu, lobortis mi. In mollis eros a posuere imperdiet.</p>
								<div class="scroll-to-section">
				...
				<div class="col-lg-4 col-12">
					<div class="features-post second-features">
						<div class="features-content">
							<div class="content-show">
								<h4>
									<i class="fa fa-graduation-cap"></i>Virtual Class
								</h4>
							</div>
							<div class="content-hide">
								<p>Curabitur id eros vehicula, tincidunt libero eu, lobortis
			...
			<div class="row">
				<div class="col-md-12">
					<div class="section-heading">
						<h2>Why choose Career Guidance?</h2>
					</div>
				</div>
				<div class="col-md-12">
					<div id='tabs'>
								...
								<div class="row">
									...
									<div class="col-md-6">
										...
										<p>
											...
											commercial purposes. You may want to make <a
												href="https://paypal.me/templatemo" target="_parent"
												rel="sponsored">a little donation</a> to TemplateMo. Please
											tell your friends about us. Thank you.
										</p>
									</div>
								</div>
							</article>
								...
								<div class="row">
									...
									<div class="col-md-6">
										...
										<p>You can modify this HTML layout by editing contents and
											...
											options to add dropdown menus, you can put many HTML pages.</p>
								...
								<div class="row">
									...
									<div class="col-md-6">
										...
										<p>
											...
											platform such as WordPress. For more information, you shall <a
												rel="nofollow" href="https://templatemo.com/contact"
												target="_parent">contact TemplateMo</a> now.
										</p>
									</div>
								</div>
							</article>
				...
				<div class="col-md-12">
					<section class='tabs-content'>
						<article>
							<div class="row">
								<div class="col-md-12">
									<h2 style="color: #fff">Best Job</h2>
									<p style="color: #fff">
										Grad School is free educational HTML template with Bootstrap
										4.5.2 CSS layout. Feel free to use it for educational or
										commercial purposes. You may want to make <a
								...
								<div class="col-md-12">
									<fieldset>
										<input name="phone-number" type="text" class="form-control"
											id="phone-number" placeholder="Your Phone Number">
									</fieldset>
								</div>
								<div class="col-md-12">
									<fieldset>
										<button type="submit" id="form-submit" class="button">Get
											it now</button>
									</fieldset>
								</div>
							</div>
				...
				<div class="owl-carousel owl-theme">
					<div class="item">
						...
						<div class="down-content">
							...
							<p>You can get free images and videos for your websites by
								visiting Unsplash, Pixabay, and Pexels.</p>
					...
					<div class="item">
						...
						<div class="down-content">
							...
							<p>Quisque cursus augue ut velit dictum, quis volutpat enim
								blandit. Maecenas a lectus ac ipsum porta.</p>
							<div class="author-image">
					...
					<div class="item">
						...
						<div class="down-content">
							...
							<p>Pellentesque ultricies diam magna, auctor cursus lectus
								pretium nec. Maecenas finibus lobortis enim.</p>
							<div class="author-image">
					...
					<div class="item">
						...
						<div class="down-content">
							...
							<p>Download free images and videos for your websites by
								visiting Unsplash, Pixabay, and Pexels.</p>
							<div class="author-image">
			...
			<div class="row">
				<div class="col-md-6 align-self-center">
					<div class="left-content">
						...
						<p>
							...
							such as WordPress. You may <a rel="nofollow"
								href="https://templatemo.com/contact" target="_parent">contact
								TemplateMo</a> for details. <br>
							<br>Suspendisse tincidunt, magna ut finibus rutrum, libero
				...
				<div class="col-md-6">
					<article class="video-item">
						...
						<figure>
							<a href="https://www.youtube.com/watch?v=r9LtOG6pNUw"
								class="play"><img src="assets/images/main-thumb.png"></a>
						</figure>
					</article>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6">
					<div id="map">
						<iframe
							src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d3890.8552903566865!2d77.64931546482003!3d12.78790364097663!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1shcl%20bangalore%20jigani%20map%20url!5e0!3m2!1sen!2sin!4v1607254410090!5m2!1sen!2sin"
